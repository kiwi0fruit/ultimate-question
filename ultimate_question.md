...
* **Spontaneous symmetry breaking** might be an important idea regarding random variation in the natural selection. _“Spontaneous”_ might refer to the immanence of _intention_ to the agents. And _“symmetry breaking”_ is necessary for random events to occur: if the symmetry doesn't break then all outcomes/impacts are equivalent and there's no randomness (“All roads lead to Rome”). Misc:
    * The notions of **recursion**, **reproduction**/**doubling** and **randomness**/**spontaneous symmetry breaking** seem to be among the keys to understanding novelty creation.
