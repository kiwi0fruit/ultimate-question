...
* разрешимость моей задачи эквивалентна тому, что поток времени это выбор между уже заранее предрешенными вариантами. идея свободы выбора/воли опирается на идею предсуществования пространства вариантов выбора. напоминает поток в интуиционистской математике. Но процесс этот должен быть не такой, как поток вещественных чисел. А с усложнением особей.
* если настоящее сотворяет будущее, а не переходит в него. И если оно не сотворит чего-то, то этого и не будет в будущем. ЭТО УДОБНО ВВОДИТ ЕСТЕСТВЕННЫЙ ОТБОР.
* живое умирает, когда перестаёт быть проводником энергии, живущим на разность энергии. беру энергию, использую её чтобы ещё взять энергию
* нужно, чтобы в интуитивном образе уже были идеи отбора чего-то посложнее. То есть не нужно придумывать модель, а потом ожидать, что в ней что-то найдется. Нужно сразу интуитивно увидеть как в интуитивном представлении что-то образуется
* разрубить все strange-loop через система всегда наблюдает и имеет модель не себя а себя-в-прошлом?
