...
*Quote from [Applying Universal Darwinism to evaluation of Terminal values](./dxb.md) (also see [Terminal Value](https://www.lesswrong.com/tag/terminal-value) definition)*.
